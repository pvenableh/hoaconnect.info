    ...
    <Card v-if="!organizationData?.custom_domain" class="mb-6">
      ...
      <CardContent>
        <form @submit.prevent="handleAddDomain" class="space-y-4">
          ...
          <div v-if="addError" class="p-3 bg-red-50 border border-red-200 rounded-lg text-red-700 text-sm">
            {{ addError }}
          </div>
        </form>
      </CardContent>
        ...
        <div class="space-y-4">
          ...
          <div class="p-4 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            <ol class="list-decimal list-inside space-y-2 text-sm text-gray-700">
              ...
              <li>Return here and click "Verify Domain" to check the status</li>
            </ol>
          </div>
          ...
          <div v-if="verifyError" class="p-3 bg-red-50 border border-red-200 rounded-lg text-red-700 text-sm">
            {{ verifyError }}
          </div>
          <div v-if="verifySuccess" class="p-3 bg-green-50 border border-green-200 rounded-lg text-green-700 text-sm">
            {{ verifySuccess }}
          </div>
        </div>
      </CardContent>
