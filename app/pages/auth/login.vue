...
<template>
  ...
  >
    ...
    <div aria-hidden="true" class="pointer-events-none absolute inset-0 overflow-hidden">
      <div
        class="absolute -top-32 -left-24 h-96 w-96 rounded-full blur-3xl opacity-30 t-bg-accent-app"
      />
      <div
        class="absolute -bottom-40 -right-20 h-[28rem] w-[28rem] rounded-full blur-3xl opacity-20 t-bg-accent-app"
      />
    </div>
