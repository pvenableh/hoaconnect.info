...
import DebugOrgData from "~/components/DebugOrgData.vue";
...
const handleEdit = (member: any) => {
  ...
  // Get primary unit or first unit
...
// Helper to get primary unit or first unit
...
<template>
  <div class="min-h-screen bg-stone-50">
    ...
    <div class="container mx-auto p-6">
      ...
      <!-- Loading State - Updated to use isLoading -->
